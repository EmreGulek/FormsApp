namespace FormsApp.Models
{
    public class Repository
    {
        ...
        static Repository()
        {
            ...
            _products.Add(new Product {ProductId = 1, Name = "IPhone 14", Price = 40000, IsActive = true,Image = "1.png",CategoryId = 1 });
            _products.Add(new Product {ProductId = 2, Name = "IPhone 15", Price = 50000, IsActive = false,Image = "2.png",CategoryId = 1 });
            _products.Add(new Product {ProductId = 3, Name = "IPhone 16", Price = 60000, IsActive = true,Image = "3.png",CategoryId = 1 });
            _products.Add(new Product {ProductId = 4, Name = "IPhone 17", Price = 70000, IsActive = false,Image = "4.png",CategoryId = 1 });
